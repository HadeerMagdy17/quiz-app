    ...
    return (
        <>
            <div className="flex items-center justify-center min-h-screen bg-white">
                <div className="w-full md:w-1/2 p-12 bg-white text-slate-950">
                    <div className="input-container pb-20">
                    ...
                    <div className="flex justify-between rounded-md border border-gray-300 w-80 m-2">
                        ...
                        <div className="bg-white  border-white rounded-md pr-2 ">10 mins</div>
                    </div>
                    <div className="flex justify-between rounded-md border border-gray-300 w-80 m-2 ">
                    ...
                    <div className=" rounded-md border border-gray-300 w-80 m-2 ">
                        ...
                        <div className="bg-white  border-white rounded-md pr-2 pl-2">Lorem ipsum aset amet consectedur im nascsa assadqw assacsc aidwqdjv asdewfas qwdass Lorem ipsum aset amet consectedur im nascsa assadqw assacsc aidwqdjv</div>
                    </div>
                    <div className="flex justify-between rounded-md border border-gray-300 w-80 m-2">
